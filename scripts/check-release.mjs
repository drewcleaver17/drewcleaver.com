...
assert(dpc.includes('data-staffing-controls')&&dpc.includes('revision-history')&&dpc.includes('R06'),'DPC must include the roster editor and revision history.');
assert(dpc.includes('coverage-table')&&dpc.includes('Core $250 / Extended $350')&&dpc.includes('$2,400 / year')&&dpc.includes('$3,360 / year'),'DPC trial pricing and readable weekly coverage must be present.');
