...
for (const page of ['index.html', 'hello/index.html', 'contact/index.html', 'buildmine/index.html', 'preview/index.html', 'motorsport/index.html', 'privacy/index.html', 'sitemap.xml', 'robots.txt', 'drew-cleaver.vcf']) {
...
for (const page of ['buildmine/index.html', 'preview/index.html', 'motorsport/index.html']) {
...
assert(!/\/(buildmine|preview|writing|motorsport)(?:\/|<)/.test(sitemap), 'Private/unlisted routes must stay out of the sitemap.');
console.log('Release check passed: contact routes present; writing absent; builder, preview, and motorsport pilots unlisted and noindex.');
