...
for (const page of ['buildmine/index.html', 'preview/index.html', 'motorsport/index.html', 'proofpath/index.html', 'tekmetric/index.html', 'metsicare/index.html', 'ufos/index.html']) {
...
assert(!/\/(buildmine|preview|writing|motorsport|proofpath|tekmetric|metsicare|ufos)(?:\/|<)/.test(sitemap), 'Private/unlisted routes must stay out of the sitemap.');
