...
table([f"Annual economics at {M['modeledMembers']} members",'USD'],[
 ['Membership revenue at $325 blended monthly dues',money(M['revenue'])],
 ...
 ['Final result after bonuses','Incomplete']
],[654,210],rowh=40,size=16)
text('Base costs: $846,000/year. Coverage costs and profit sharing are additional. Before tax, depreciation and financing.',48,467,864,26,11)
...
text('Shorter blocks change the offering and require clinical review. Pricing does not increase the access limit. The 360-member request still exceeds the 325-member reference target.',48,432,864,58,16,bold=True)
...
text('Sensitivity: 325 members; 25% Core / 75% Extended; all four unpriced coverage increments set to $0; all quality conditions achieved. No ancillary income. Final reference profit remains incomplete.',48,449,864,42,12,bold=True)
